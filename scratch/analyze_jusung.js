...
(async () => {
    try {
        console.log("Fetching Jusung Engineering (036930) details from KIS...");
        const detail = await fetchStockFullDetailFromKIS('036930', null, false);
        const estimate = await fetchStockIntradayInvestorEstimate('036930');

        console.log("\n=================== JUSUNG ENGINEERING (036930) DIAGNOSTICS ===================");
