...
(async () => {
    try {
        console.log("Fetching SK Eternix (475150) details from KIS...");
        const detail = await fetchStockFullDetailFromKIS('475150', null, false);
        const estimate = await fetchStockIntradayInvestorEstimate('475150');

        console.log("\n=================== SK ETERNIX (475150) DIAGNOSTICS ===================");
