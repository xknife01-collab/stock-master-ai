...
(async () => {
    try {
        console.log("Fetching Hana Micron (067310) details from KIS...");
        const detail = await fetchStockFullDetailFromKIS('067310', null, false);
        const estimate = await fetchStockIntradayInvestorEstimate('067310');

        console.log("\n=================== HANA MICRON (067310) DIAGNOSTICS ===================");
